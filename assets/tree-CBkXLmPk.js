import{r as l,k as y,n as z,f as s,w as a,h as t,b as D,aH as p,aI as m,g as n,t as F}from"./index-DMavrnVt.js";const S={class:"markdown-body"},E=t("div",{class:"describe-plugin"},[t("p",null,"树形组件一般用于展示具有层级关系的数据")],-1),I=t("p",null,[n("使用 "),t("code",null,"lay-tree"),n(" 标签, 创建树形组件, @node-click 监听节点点击。")],-1),U=t("pre",null,[t("code",{"v-pre":""},[t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"<"),n("template")]),t("span",{class:"token punctuation"},">")]),n(`
...
`)])],-1),A=t("p",null,[n("使用 "),t("code",null,"showCheckbox"),n(" 属性开启复选框, "),t("code",null,"checkedKeys"),n(" 属性设置选中项。")],-1),B=t("pre",null,[t("code",{"v-pre":""},[t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"<"),n("template")]),t("span",{class:"token punctuation"},">")]),n(`
  `),t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"<"),n("lay-tree")]),n(`
...
`)])]),t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"</"),n("script")]),t("span",{class:"token punctuation"},">")]),n(`
`)])],-1),H=t("p",null,"使用插槽自定义节点标题",-1),R=t("pre",null,[t("code",{"v-pre":""},[t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"<"),n("template")]),t("span",{class:"token punctuation"},">")]),n(`
...
`),t("span",{class:"token keyword"},"import"),n(),t("span",{class:"token punctuation"},"{"),n(" ref "),t("span",{class:"token punctuation"},"}"),n(),t("span",{class:"token keyword"},"from"),n(),t("span",{class:"token string"},"'vue'"),t("span",{class:"token punctuation"},";"),n(`
`)])]),t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"</"),n("script")]),t("span",{class:"token punctuation"},">")]),n(`
`)])],-1),G=t("p",null,"异步加载子节点",-1),Q=t("pre",null,[t("code",{"v-pre":""},[t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"<"),n("template")]),t("span",{class:"token punctuation"},">")]),n(`
