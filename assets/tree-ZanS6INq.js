import{r as l,k as y,n as F,f as s,w as a,h as t,b as z,aw as p,aF as m,g as n,t as D}from"./index-RaQTBs99.js";const S={class:"markdown-body"},E=t("div",{class:"describe-plugin"},[t("p",null,"树形组件一般用于展示具有层级关系的数据")],-1),U=t("p",null,[n("使用 "),t("code",null,"lay-tree"),n(" 标签, 创建树形组件, @node-click 监听节点点击。")],-1),A=t("pre",null,[t("code",{"v-pre":""},[t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"<"),n("template")]),t("span",{class:"token punctuation"},">")]),n(`
