...
`),t("span",{class:"token punctuation"},"}"),t("span",{class:"token punctuation"},"]"),t("span",{class:"token punctuation"},")"),t("span",{class:"token punctuation"},";"),n(`
`)])]),t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"</"),n("script")]),t("span",{class:"token punctuation"},">")]),n(`
`)])],-1)])]),default:p(()=>[a(u,{modelValue:e(v),"onUpdate:modelValue":s[8]||(s[8]=o=>k(v)?v.value=o:v=o),data:e(D),placeholder:"请选择",onChange:e(x),multiple:!0},{title:p(({data:o})=>[t("div",null,[a(q,{type:"layui-icon-addition"}),n(" "+J(o.title),1)])]),_:1},8,["modelValue","data","onChange"])]),_:1}),a(c,{id:"tree 自定义字段",title:"tree 自定义字段",style:{"margin-top":"21px","margin-bottom":"20px"}}),a(y,null,{description:p(()=>[...s[26]||(s[26]=[t("p",null,[n("tree 组件 使用 "),t("code",null,"replaceFields"),n(" 替换 "),t("code",null,"data"),n(" 中的字段名")],-1)])]),code:p(()=>[...s[27]||(s[27]=[t("pre",null,[t("code",{"v-pre":""},[t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"<"),n("template")]),t("span",{class:"token punctuation"},">")]),n(`
